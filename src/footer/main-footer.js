...
function FirstFooter() {
  ...
  return (
    <>
      <div className="sm:bg-secondary dark:bg-[#0A0B14] min-[375px]:bg-neutralWhite min-[375px]:py-6 min-[375px]:gap-4 sm:gap-4 sm:py-8 sm:px-4 flex sm:flex-row xl:py-20 lg:px-12 lg:py-12 lg:gap-12 xl:px-28 xl:gap-28 items-center min-[375px]:flex-col min-[375px]:w-full">
        ...
        <div className="sm:w-3/6 xl:px-8">
          <div className="min-[375px]:py-6 min-[375px]:px-0  sm:px-4 sm:py-6 min-[375px]:bg-secondary sm:bg-neutralWhite dark:bg-[#1a2e42]  xl:py-12 lg:px-12 xl:px-6  lg:py-10 h-full flex flex-col justify-center">
            <h2 className="min-[375px]:text-xl sm:text-3xl min-[375px]:px-8 dark:text-neutralWhite text-primary font-header">
              Get In touch
            </h2>
            <h3 className="min-[375px]:text-base sm:text-xl min-[375px]:px-8 dark:text-secondary text-primary font-body">
              You can reach us anytime
            </h3>
            <form className="flex min-[375px]:px-8 flex-col justify-center lg:gap-4 mt-6 min-[375px]:mt-3 sm:gap-2 min-[375px]:gap-2">
              <div className="flex flex-row items-center justify-center gap-4">
                <label>
                  <input
                    type="text"
                    placeholder="First Name"
                    className="w-full placeholder:opacity-50 ps-4 h-8 placeholder:text-sm"
                  />
                </label>
                <label>
                  <input
                    ...
                    className="w-full sm:ps-2 placeholder:opacity-50 ps-4 h-8 placeholder:text-sm"
                  />
                </label>
              </div>
              <label>
              ...
              <textarea
                cols="30"
                rows="10"
                className="lg:h-28 sm:h-16 placeholder:opacity-50 placeholder:pt-4 ps-4"
      ...
      <div className="sm:py-8 min-[375px]:flex-col min-[375px]:gap-6 lg:flex-row flex justify-center lg:gap-12 lg:ps-12 xl:gap-28 xl:ps-28 lg:pe-12 bg-secondary lg:py-12 dark:bg-[#0A0B14]">
        <div className="flex flex-col justify-center w-full gap-6 min-[375px]:items-center ">
          ...
          <div className="flex items-center xl:gap-8 lg:gap-6 sm:gap-6 min-[375px]:gap-3">
            <img src={dark.dark==='dark' ? darkfacebook : facebook} alt="facebook" />
            <img src={dark.dark==='dark' ? darkinstagram : instagram} alt="instagram" />
            <img src={dark.dark==='dark' ? darkyoutube : youtube} alt="youtube" />
            <img src={dark.dark==='dark' ? darktwitter : twitter} alt="twitter" />
            <img src={dark.dark==='dark' ? darktiktok : tiktok} alt="tiktok" />
            <img src={dark.dark==='dark' ? darkwhatup : whatup} alt="whatup" />
          </div>
        </div>
      ...
      <div className="py-6 text-center sm:text-xl min-[375px]:text-sm lg:text-3xl text-secondary font-header dark:bg-black">
